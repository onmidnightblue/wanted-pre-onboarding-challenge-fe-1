...
>>>>>>> b2ae81475a0104d9f1ec9936c9171d629d6b82ac
    - [ ]  수정 선택 후 다른 리스트를 클릭했을 때 수정 폼 안의 내용이 바뀌지 않는 오류 수정하기
    - [ ]  리스트를 선택하지 않았을 때 수정 선택 후 폼이 잠깐 뜨는 오류 수정하기
    - [ ]  리스트 선택 후 해제했을 때 상세 내용이 이전꺼가 남아있는 오류 수정하기
<br />
